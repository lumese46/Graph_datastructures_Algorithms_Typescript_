...
var list_iterator_1 = __importDefault(require("./lib/list-iterator"));
var list_node_1 = __importDefault(require("./lib/list-node"));
/**
 * Linked list class
 *
...
var LinkedList = /** @class */ (function () {
    ...
    function LinkedList(arr) {
        ...
        this.iterator = new list_iterator_1.default(this);
     ...
     */
    LinkedList.prototype.createNewNode = function (data) {
        return new list_node_1.default(data);
    };
    /**
    ...
    LinkedList.prototype.insertAt = function (index, data) {
        var current = this.getHeadNode(), previous = null, position = 0;
        var newNode = this.createNewNode(data);
     ...
     * @returns {boolean} true if insert operation was successful
     */
    LinkedList.prototype.insertBefore = function (nodeData, dataToInsert) {
     ...
     * @returns {boolean} true if insert operation was successful
     */
    LinkedList.prototype.insertAfter = function (nodeData, dataToInsert) {
        var index = this.indexOf(nodeData);
    ...
    LinkedList.prototype.indexOf = function (data) {
        ...
        while (this.iterator.hasNext()) {
            current = this.iterator.next();
            if (lodash_isequal_1.default(current.getData(), data)) {
                return index;
            }
            index += 1;
        }
